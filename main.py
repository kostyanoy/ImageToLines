...
image_path = "test4.jpg"  # image name

image_folder = "images"
model_folder = "models"
result_folder = "result/test4"
...
for m in models:
    im1 = not_conf_m.process_image(f"{image_folder}/{image_path}", f"{model_folder}/{m}")
    im2 = conf_m.process_image(f"{image_folder}/{image_path}", f"{model_folder}/{m}")
